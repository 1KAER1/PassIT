...
public class LabInfoRVAdapter extends RecyclerView.Adapter<LabInfoRVAdapter.ViewHolder> {

    private final List<LessonDate> lessonDates;

    public LabInfoRVAdapter(List<LessonDate> lessonDates) {
        this.lessonDates = lessonDates;
    }

    @NonNull
    @Override
    public LabInfoRVAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.recyclerview_summary_row, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull LabInfoRVAdapter.ViewHolder holder, int position) {
