...
public class ExerciseInfoRVAdapter extends RecyclerView.Adapter<ExerciseInfoRVAdapter.ViewHolder> {

    private final List<LessonDate> lessonDates;

    public ExerciseInfoRVAdapter(List<LessonDate> lessonDates) {
        this.lessonDates = lessonDates;
    }

    @NonNull
    @Override
    public ExerciseInfoRVAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.recyclerview_summary_row, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ExerciseInfoRVAdapter.ViewHolder holder, int position) {
